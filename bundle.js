...
const Time = function (date) {
  const dateString = date;
  const dateObj = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dateString, "yyyy-MM-dd HH:mm", new Date());
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateObj, "h:mm aaaa");
  return formattedDate;
};
...
/* harmony import */ var _date_refresh__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./date-refresh */ "./src/modules/date-refresh.js");
...
const Refresh = async function(newCity) {
    ...
    (0,_date_refresh__WEBPACK_IMPORTED_MODULE_2__["default"])(newCity);
